...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const originalLoop = gameLoop.loop; // Access private loop for extension
        ...
        gameLoop.loop = (currentTime) => {
            ...
            let deltaTime = (currentTime - gameLoop.lastTime) / 1000;
            ...
            // }
            const halfWidth = ((spriteComp === null || spriteComp === void 0 ? void 0 : spriteComp.width) || 32) / 2;
            const halfHeight = ((spriteComp === null || spriteComp === void 0 ? void 0 : spriteComp.height) || 32) / 2;
            ...
            if (gameLoop.isRunning) {
                gameLoop.rafId = requestAnimationFrame(gameLoop.loop);
            }
        };
        gameLoop.start();
