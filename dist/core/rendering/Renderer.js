...
import { debug, warn, error } from '../utils/logger.js'; // Import logger functions
export class Renderer {
    constructor(canvas) {
        this.stars = [];
        this.starScrollY = 0; // Tracks overall scroll offset
    ...
    renderScene(scene, objectManager, assetLoader, deltaTime) {
